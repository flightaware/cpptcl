...
#include "details/metahelpers.h"
	...
	class interpreter
	{
		public:
			...
			template <typename R>
				...
				{
					add_function(name, std::shared_ptr<details::callback_base>(new details::callback0<R>(f)), p);
				}

			template <typename R, typename T1>
				void def(std::string const &name, R (*f)(T1), policies const &p = policies())
				{
					add_function(name, std::shared_ptr<details::callback_base>(new details::callback1<R, T1>(f)), p);
				}
			...
			template <typename R, typename T1, typename T2>
				...
				{
					add_function(name,
								 std::shared_ptr<details::callback_base>(new details::callback2<R, T1, T2>(f)), p);
				}

			template <typename R, typename T1, typename T2, typename T3>
				void def(std::string const &name, R (*f)(T1, T2, T3), policies const &p = policies())
				{
					add_function(name, std::shared_ptr<details::callback_base>( new details::callback3<R, T1, T2, T3>(f)), p);
				}

			template <typename R, typename T1, typename T2, typename T3, typename T4>
				void def(std::string const &name, R (*f)(T1, T2, T3, T4), policies const &p = policies())
				{
					add_function(name, std::shared_ptr<details::callback_base>( new details::callback4<R, T1, T2, T3, T4>(f)), p);
				}

			template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5>
						 void def(std::string const &name, R (*f)(T1, T2, T3, T4, T5), policies const &p = policies())
						 {
							 add_function(name, std::shared_ptr<details::callback_base>( new details::callback5<R, T1, T2, T3, T4, T5>(f)), p);
						 }

			template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>
						 void def(std::string const &name, R (*f)(T1, T2, T3, T4, T5, T6), policies const &p = policies())
						 {
							 add_function(name, std::shared_ptr<details::callback_base>( new details::callback6<R, T1, T2, T3, T4, T5, T6>(f)), p);
						 }

			template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
						 void def(std::string const &name, R (*f)(T1, T2, T3, T4, T5, T6, T7), policies const &p = policies())
						 {
							 add_function(name, std::shared_ptr<details::callback_base>( new details::callback7<R, T1, T2, T3, T4, T5, T6, T7>(f)), p);
						 }

			template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>
						 void def(std::string const &name, R (*f)(T1, T2, T3, T4, T5, T6, T7, T8), policies const &p = policies())
						 {
							 add_function(name, std::shared_ptr<details::callback_base>( new details::callback8<R, T1, T2, T3, T4, T5, T6, T7, T8>(f)), p);
						 }

			template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
						 void def(std::string const &name, R (*f)(T1, T2, T3, T4, T5, T6, T7, T8, T9), policies const &p = policies())
						 {
							 add_function(name, std::shared_ptr<details::callback_base>( new details::callback9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9>(f)), p);
						 }
	...
	class object
	{
		public:
			...
			// the InputIterator should give object& or Tcl_Obj* when dereferenced
			template <class InputIterator>
				object(InputIterator first, InputIterator last) : interp_(0)
				{
